				...
				<div class="d-flex align-items-center flex-wrap mr-2">
					...
					<div class="d-flex flex-column">
						...
						<div class="d-flex align-items-center font-weight-bold my-2">
							...
							<!--begin::Item-->
							<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
							<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Editar Usuario</a>
							<!--end::Item-->
						</div>
						<!--end::Breadcrumb-->
					</div>
													...
													<div class="col-xl-9">
														...
														<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9 col-md-9">
																	<div class="image-input image-input-outline" id="kt_user_add_avatar">
																		...
																		@else
																			<div class="image-input-wrapper" style="background-image: url({{ asset('uploads/users/'.$user->avatar) }})"></div>
																		@endif
															...
															<div class="form-group row">
																	...
																	<div class="col-lg-9 col-md-9 col-xl-9">
																			{!! Form::select('role', $roles, $user->role, ['class' => 'form-control form-control-lg form-control-solid']) !!}
															...
															<div class="form-group row">
																	...
																	<div class="col-lg-9 col-xl-9 col-md-9">
																			<div class="input-group input-group-solid input-group-lg">
																					...
																					<input type="text" class="form-control form-control-solid form-control-lg" name="phone" value="{{ $user->phone }}" placeholder="Phone" />
																			</div>
														...
														<div class="my-5 step" data-wizard-type="step-content">
																...
																<div class="form-group row">
																		...
																		<div class="col-xl-9 col-lg-9 col-md-9">
																				{!! Form::select('gym_id', $gyms, $user->gym_id, ['class' => 'form-control form-control-lg form-control-solid']) !!}
															...
															<div class="row">
																<div class="col-xl-6 col-md-6">
																	<div class="form-group">
																			...
																			<input type="text" class="form-control form-control-solid form-control-lg" readonly name="height" placeholder="Altura" value="{{ isset($pInfo->height)?$pInfo->height:'' }}" />
																...
																<div class="col-xl-6 col-md-6">
																	...
																	<div class="form-group">
																			...
																			<input type="text" class="form-control form-control-solid form-control-lg" readonly name="weight" placeholder="Peso" value="{{ isset($pInfo->weight)?$pInfo->weight:'' }}" />
															...
															<div class="row">
																	<div class="col-xl-4 col-md-4">
																			...
																			<div class="form-group">
																					...
																					<input type="text" class="form-control form-control-solid form-control-lg" readonly name="fat_percentage" placeholder="Porciento de grasa corporal" value="{{ isset($pInfo->fat_percentage)?$pInfo->fat_percentage:'' }}" />
																	...
																	<div class="col-xl-4 col-md-4">
																		...
																		<div class="form-group">
																				...
																				<input type="text" class="form-control form-control-solid form-control-lg" readonly name="age" placeholder="Edad" value="{{ isset($pInfo->age)?$pInfo->age:'' }}" />
																	...
																	<div class="col-xl-4 col-md-4">
																			...
																			<div class="form-group">
																					...
																					<input type="text" class="form-control form-control-solid form-control-lg" readonly name="sex" placeholder="Sexo" value="{{ isset($pInfo->sex)?$pInfo->sex:'' }}" />
														...
														<div class="my-5 step" data-wizard-type="step-content">
															...
															<!--begin::Item-->
															<div class="border-bottom mb-5 pb-5">
																	<div class="font-weight-bolder mb-3">Detalles somatotipo: Solo Lectura</div>
